/**
 * aiCommandProcessor.js â€” EcoVoice AI Command Layer
 * ---------------------------------------------------
 * Uses Groq (llama-3.3-70b-versatile) to extract intents from natural language.
 *
 * CONTRACT â€” every result includes a `response` field:
 ...
 * (Groq uses stateless completions â€” history is reconstructed each call).
 *
...
// â”€â”€â”€ Groq client â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

const API_KEY = import.meta.env.VITE_GROQ_API_KEY;
const MODEL   = 'llama-3.3-70b-versatile';

// â”€â”€â”€ Startup key detection log â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
if (API_KEY && API_KEY !== 'your_groq_api_key_here') {
  console.log('[EcoVoice/AI] API key detected â€” Groq AI layer is active.');
} else {
  console.warn('[EcoVoice/AI] API key missing â€” all requests will fall back to rule-based parser.');
}
...
const SYSTEM_PROMPT = `You are EcoVoice â€” a warm, intelligent, voice-first productivity assistant.
...
Every response must include a short, warm, conversational "response" field â€” always in English.

â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
INTENT TYPES
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

CREATE_TASK     â†’ user wants to add, remember, schedule, or do something
DELETE_TASK     â†’ user wants to delete, remove, or erase a task
COMPLETE_TASK   â†’ user wants to mark a task done / finished / complete
UNCOMPLETE_TASK â†’ user wants to revert a task to pending / incomplete
PIN_TASK        â†’ user wants to pin, star, or mark a task as important
UNPIN_TASK      â†’ user wants to unpin, unstar, or deprioritise a task
SET_PRIORITY    â†’ user explicitly sets high or normal priority for a task
CHAT            â†’ everything else: questions, greetings, conversations

â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
JSON SCHEMAS â€” return EXACTLY ONE
...
CHAT:
{ "intent": "CHAT", "response": "<helpful, conversational reply â€” max 2 sentences>" }
...
- Sound warm, human, and encouraging â€” like a calm personal assistant.
...
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
"Kal subah DSA padhni hai"      â†’ CREATE_TASK, task: "study DSA tomorrow morning"
"Mujhe DSA padhni hai"          â†’ CREATE_TASK, task: "study DSA"
"Kal gym jana hai"              â†’ CREATE_TASK, task: "go to gym tomorrow"
"Grocery leni hai"              â†’ CREATE_TASK, task: "buy groceries"
"Ye task important hai"         â†’ PIN_TASK, task from context
"DSA wala task delete kar do"   â†’ DELETE_TASK, task: "DSA"
"Namaste"                       â†’ CHAT, response: "Namaste! What would you like to work on today?"

â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
TASK LABEL EXTRACTION RULES
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
Strip all filler words. Keep only the action + subject in English.
- "I need to study DSA"         â†’ task: "study DSA"
- "remind me to call mom"       â†’ task: "call mom"
- "Mujhe DSA padhni hai"        â†’ task: "study DSA"
- "Kal gym jana hai"            â†’ task: "go to gym tomorrow"

â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
RESPONSE EXAMPLES (model your tone on these)
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
CREATE_TASK â†’ "Got it, I've added that to your list."
DELETE_TASK â†’ "Sure, I've removed that task for you."
COMPLETE_TASK â†’ "Great work! I've marked that as done."
UNCOMPLETE_TASK â†’ "No problem, I've moved it back to pending."
PIN_TASK â†’ "Done. That's now pinned at the top of your list."
UNPIN_TASK â†’ "Got it, I've unpinned that task."
SET_PRIORITY (high) â†’ "Noted. I've marked that as high priority."
SET_PRIORITY (normal) â†’ "Done, priority has been set back to normal."
CHAT (hello) â†’ "Hey! Just speak naturally and I'll take care of your tasks."
CHAT (what can you do) â†’ "I can create, complete, delete, pin, and prioritise your tasks using natural voice commands."`;

// â”€â”€â”€ Session memory store â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

/**
 * In-memory conversation history â€” last MAX_HISTORY turn pairs.
 ...
 * Gemini uses role 'model' â€” Groq/OpenAI uses role 'assistant'.
 */
...
// â”€â”€â”€ JSON extractor â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Missing target helper â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Groq JSON â†’ internal command object â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
 ...
 *
 * A3 â€” On repeated failures returns GEMINI_UNAVAILABLE (type name kept for
...
export async function processWithAI(rawText) {
  ...
  if (!groq) {
    console.warn('[EcoVoice/AI] No Groq API key â€” using rule-based parser as fallback.');
  ...
  try {
    ...
    // A3 â€” success: reset failure counter
    ...
    if (command.type !== 'CHAT') {
      ...
      if (payload.trim() === '') {
        console.warn('[EcoVoice/AI] Empty task payload â€” falling back to rule parser.');
        return parseCommand(rawText);
      }
    }
    ...
    console.error(
      `[EcoVoice/AI] Groq error (failure #${_consecutiveFailures}) â€” falling back to rule parser:`,
      error
    );

    // A3 â€” after repeated failures, surface a friendly notice to the user
    if (_consecutiveFailures >= MAX_FAILURES_BEFORE_WARN) {
      ...
      const message = isRateLimit
        ...
        : 'Groq is currently unavailable. Task Manager mode remains active â€” all voice commands still work.';

      return {
        type:     'GEMINI_UNAVAILABLE', // keep this type â€” App.jsx handles it unchanged
        response: message,
